  ...
  [1217],
  {
    1217: (f, l, n) => {
      ...
      let p = class {
          constructor(e) {
            (0, t.r)(this, e),
              (this.ionInput = (0, t.e)(this, 'ionInput', 7)),
              (this.ionChange = (0, t.e)(this, 'ionChange', 7)),
              (this.ionBlur = (0, t.e)(this, 'ionBlur', 7)),
              (this.ionFocus = (0, t.e)(this, 'ionFocus', 7)),
              (this.ionStyle = (0, t.e)(this, 'ionStyle', 7)),
              (this.inputId = 'ion-input-' + g++),
              ...
              (this.onInput = (i) => {
                const o = i.target;
                o && (this.value = o.value || ''), this.ionInput.emit(i);
              }),
              (this.onBlur = (i) => {
                (this.hasFocus = !1),
                  this.focusChanged(),
              ...
              (this.onKeydown = (i) => {
                this.shouldClearOnEdit() &&
                  (this.didBlurAfterEdit && this.hasValue() && 'Enter' !== i.key && this.clearTextInput(),
                  (this.didBlurAfterEdit = !1));
              }),
              (this.clearTextOnEnter = (i) => {
                'Enter' === i.key && this.clearTextInput(i);
              }),
          ...
          debounceChanged() {
            this.ionChange = (0, a.j)(this.ionChange, this.debounce);
          }
          disabledChanged() {
            this.emitStyle();
          }
          ...
          componentWillLoad() {
            this.inheritedAttributes = (0, a.i)(this.el, ['aria-label', 'tabindex', 'title']);
          }
          connectedCallback() {
            this.emitStyle(),
          ...
          shouldClearOnEdit() {
            const { type: e, clearOnEdit: i } = this;
            return void 0 === i ? 'password' === e : i;
          }
          getValue() {
            ...
            return (
              ...
              (0, t.h)(
                t.H,
                {
                  ...
                  class: (0, h.c)(this.color, { [e]: !0, 'has-value': this.hasValue(), 'has-focus': this.hasFocus }),
                },
                (0, t.h)(
                  'input',
                  Object.assign(
