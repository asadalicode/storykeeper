...
(self.webpackChunkngx_new = self.webpackChunkngx_new || []).push([
  ...
  {
    5836: (B, l, n) => {
      n.r(l), n.d(l, { ion_fab: () => b, ion_fab_button: () => d, ion_fab_list: () => g });
      var v = n(5861),
        t = n(9533),
        e = n(7639),
        s = n(7300);
      let b = class {
        constructor(o) {
          (0, t.r)(this, o),
            ...
            (this.activated = !1),
            (this.onClick = () => {
              const r = !!this.el.querySelector('ion-fab-list'),
                i = this.getFab();
              r && (!i || !i.disabled) && (this.activated = !this.activated);
            });
        }
        activatedChanged() {
          const o = this.activated,
            r = this.getFab();
          r && (r.activated = o),
            Array.from(this.el.querySelectorAll('ion-fab-list')).forEach((i) => {
              i.activated = o;
            });
        }
        componentDidLoad() {
        ...
        render() {
          const { horizontal: o, vertical: r, edge: i } = this,
            a = (0, e.b)(this);
          return (0, t.h)(
            t.H,
            {
      ...
      let d = class {
        constructor(o) {
          (0, t.r)(this, o),
            (this.ionFocus = (0, t.e)(this, 'ionFocus', 7)),
            (this.ionBlur = (0, t.e)(this, 'ionBlur', 7)),
            (this.activated = !1),
            (this.disabled = !1),
        ...
        render() {
          const { el: o, disabled: r, color: i, href: a, activated: c, show: z, translucent: p, size: h } = this,
            f = (0, s.h)('ion-fab-list', o),
            u = (0, e.b)(this),
            m = void 0 === a ? 'button' : 'a',
            _ =
              'button' === m
                ? { type: this.type }
                : { download: this.download, href: a, rel: this.rel, target: this.target };
          return (0, t.h)(
            t.H,
            {
            ...
            (0, t.h)(
              ...
              Object.assign({}, _, {
                ...
                onBlur: this.onBlur,
                onClick: (C) => (0, s.o)(a, C, this.routerDirection, this.routerAnimation),
              }),
              (0, t.h)('ion-icon', { icon: this.closeIcon, part: 'close-icon', class: 'close-icon', lazy: !1 }),
              (0, t.h)('span', { class: 'button-inner' }, (0, t.h)('slot', null)),
              'md' === u && (0, t.h)('ion-ripple-effect', null)
            )
          );
        }
        get el() {
      ...
      let g = class {
        constructor(o) {
          (0, t.r)(this, o), (this.activated = !1), (this.side = 'bottom');
        }
        activatedChanged(o) {
          const r = Array.from(this.el.querySelectorAll('ion-fab-button')),
            i = o ? 30 : 0;
          r.forEach((a, c) => {
            setTimeout(() => (a.show = o), c * i);
          });
        }
        render() {
          const o = (0, e.b)(this);
          return (0, t.h)(
            t.H,
            { class: { [o]: !0, 'fab-list-active': this.activated, [`fab-list-side-${this.side}`]: !0 } },
            (0, t.h)('slot', null)
          );
        }
        get el() {
