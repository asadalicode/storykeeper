...
(self.webpackChunkngx_new = self.webpackChunkngx_new || []).push([
  ...
  {
    2289: (G, C, f) => {
      f.r(C), f.d(C, { ion_virtual_scroll: () => w });
      var x = f(5861),
        u = f(9533),
        O = f(6499);
      const g = 'item',
      ...
      let w = class {
        ...
        positionForItem(t) {
          return Promise.resolve(
            ((t, e, i) => {
              const s = e.find((r) => r.type === g && r.index === t);
              return s ? i[s.i] : -1;
        ...
        writeVS() {
          const t = this.indexDirty,
            ...
            r = ((t, e, i) => {
              ...
              const l = Math.max(o - 2 - 1, 0);
              for (; o < t.length && !(t[o] >= r); o++);
              return { offset: l, length: Math.min(o + 2, t.length) - l };
            })(s, i);
          !((t, e, i) => t <= i.offset + i.length || e.offset !== i.offset || e.length !== i.length)(
            ...
            ((t, e, i, s) => {
              ...
              const l = t.filter((n) => n.d);
              for (const n of r) {
                const h = l.find((c) => c.d && c.cell.type === n.type),
                  a = n.i;
                h
            ...
            })(this.virtualDom, s, this.cells, r),
            this.nodeRender
              ? ((t, e, i, s) => {
                  const r = Array.from(t.children).filter((n) => 'TEMPLATE' !== n.tagName),
                    o = r.length;
                  let l;
                  for (let n = 0; n < i.length; n++) {
                    const h = i[n],
                      a = h.cell;
                    if (2 === h.change) {
                      if (n < o) (l = r[n]), e(l, a, n);
                      else {
                        const m = U(t, a.type);
                        (l = e(m, a, n) || m), l.classList.add('virtual-item'), t.appendChild(l);
                      }
                      l.$ionCell = a;
                    } else l = r[n];
                    0 !== h.change && (l.style.transform = `translate3d(0,${h.top}px,0)`);
                    const c = a.visible;
                    h.visible !== c &&
                      (c ? l.classList.remove('virtual-loading') : l.classList.add('virtual-loading'), (h.visible = c)),
                      a.reads > 0 && (s(a, l), a.reads--);
                  }
          ...
          const i = () => {
            if (e.$ionCell === t) {
              const s = window.getComputedStyle(e),
                r = e.offsetHeight + parseFloat(s.getPropertyValue('margin-bottom'));
              this.setCellHeight(t, r);
            }
          };
          e ? (0, O.c)(e, i) : i();
        }
        ...
        i.map(e, (s, r) => {
          ...
          return (
            ...
            Object.assign(Object.assign({}, s), {
              vattrs: Object.assign(Object.assign({}, l), {
                class: n,
                style: Object.assign(Object.assign({}, l.style), { transform: `translate3d(0,${o.top}px,0)` }),
              }),
            })
          );
        });
