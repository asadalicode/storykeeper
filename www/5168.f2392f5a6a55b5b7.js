...
(self.webpackChunkngx_new = self.webpackChunkngx_new || []).push([
  [5168],
  {
    5168: (D, d, n) => {
      ...
      let c = class {
        constructor(t) {
          (0, e.r)(this, t),
            ...
            (this.value = 'on'),
            (this.onClick = (a) => {
              a.preventDefault(), this.lastDrag + 300 < Date.now() && (this.checked = !this.checked);
            }),
            (this.onFocus = () => {
              this.ionFocus.emit();
            }),
        ...
        connectedCallback() {
          ...
          return (0, h.Z)(function* () {
            (t.gesture = (yield Promise.resolve().then(n.bind(n, 1363))).createGesture({
              el: t.el,
              gestureName: 'toggle',
              gesturePriority: 100,
              threshold: 5,
        ...
        onMove(t) {
          k(document, this.checked, t.deltaX, -10) && ((this.checked = !this.checked), (0, b.c)());
        }
        onEnd(t) {
          (this.activated = !1),
        ...
        render() {
          const { activated: t, color: a, checked: i, disabled: o, el: r, inputId: s, name: f } = this,
            v = (0, p.b)(this),
            { label: w, labelId: y, labelText: _ } = (0, l.e)(r, s),
            E = this.getValue();
          return (
            (0, l.h)(!0, r, f, i ? E : '', o),
            (0, e.h)(
              e.H,
              {
                ...
                'aria-labelledby': w ? y : null,
                'aria-checked': `${i}`,
                'aria-hidden': o ? 'true' : null,
                role: 'switch',
                class: (0, g.c)(a, {
                  [v]: !0,
                  'in-item': (0, g.h)('ion-item', r),
                  'toggle-activated': t,
                  'toggle-checked': i,
                  'toggle-disabled': o,
                  interactive: !0,
              ...
              (0, e.h)(
                ...
                (0, e.h)(
                  ...
                  (0, e.h)('div', { class: 'toggle-inner', part: 'handle' })
                )
              ),
              (0, e.h)('label', { htmlFor: s }, _),
              (0, e.h)('input', {
                type: 'checkbox',
                role: 'switch',
                'aria-checked': `${i}`,
      ...
      const k = (t, a, i, o) => {
        const r = 'rtl' === t.dir;
        return a ? (!r && o > i) || (r && -o < i) : (!r && -o < i) || (r && o > i);
      };
      let x = 0;
      c.style = {
