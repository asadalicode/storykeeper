...
(self.webpackChunkngx_new = self.webpackChunkngx_new || []).push([
  ...
  {
    4753: (b, r, i) => {
      i.r(r), i.d(r, { ion_avatar: () => d, ion_badge: () => n, ion_thumbnail: () => s });
      var t = i(9533),
        a = i(7639),
        e = i(7300);
      let d = class {
        ...
        render() {
          return (0, t.h)(t.H, { class: (0, a.b)(this) }, (0, t.h)('slot', null));
        }
      };
      d.style = {
      ...
      let n = class {
        ...
        render() {
          const o = (0, a.b)(this);
          return (0, t.h)(t.H, { class: (0, e.c)(this.color, { [o]: !0 }) }, (0, t.h)('slot', null));
        }
      };
      n.style = {
