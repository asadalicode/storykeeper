...
(self.webpackChunkngx_new = self.webpackChunkngx_new || []).push([
  ...
  {
    2933: (z, g, r) => {
      r.r(g), r.d(g, { ion_item_option: () => c, ion_item_options: () => f, ion_item_sliding: () => x });
      var d = r(5861),
        n = r(9533),
        p = r(7639),
        w = r(7300),
      ...
      let c = class {
        ...
        render() {
          const { disabled: t, expandable: i, href: e } = this,
            ...
            o = (0, p.b)(this),
            l =
              'button' === s ? { type: this.type } : { download: this.download, href: this.href, target: this.target };
          return (0, n.h)(
            n.H,
            {
            ...
            (0, n.h)(
              ...
              (0, n.h)(
                ...
                (0, n.h)(
                  ...
                  (0, n.h)('slot', { name: 'icon-only' }),
                  (0, n.h)('slot', null),
                  (0, n.h)('slot', { name: 'end' })
                ),
                (0, n.h)('slot', { name: 'bottom' })
              ),
              'md' === o && (0, n.h)('ion-ripple-effect', null)
            )
          );
        }
        get el() {
      ...
      let f = class {
        constructor(t) {
          (0, n.r)(this, t), (this.ionSwipe = (0, n.e)(this, 'ionSwipe', 7)), (this.side = 'end');
        }
        fireSwipeEvent() {
          var t = this;
      ...
      let a,
        x = class {
          constructor(t) {
            (0, n.r)(this, t),
              (this.ionDrag = (0, n.e)(this, 'ionDrag', 7)),
              (this.item = null),
              (this.openAmount = 0),
          ...
          connectedCallback() {
            ...
            return (0, d.Z)(function* () {
              (t.item = t.el.querySelector('ion-item')),
                (t.closestContent = t.el.closest('ion-content')),
                yield t.updateOptions(),
                (t.gesture = (yield Promise.resolve().then(r.bind(r, 1363))).createGesture({
                  el: t.el,
          ...
          open(t) {
            ...
            return (0, d.Z)(function* () {
              ...
              const e = i.getOptions(t);
              e &&
                (void 0 === t && (t = e === i.leftOptions ? 'start' : 'end'),
                (t = (0, m.n)(t) ? 'end' : 'start'),
                (i.openAmount < 0 && e === i.leftOptions) ||
                  (i.openAmount > 0 && e === i.rightOptions) ||
                  (i.closeOpened(),
                  (i.state = 4),
                  requestAnimationFrame(() => {
                    i.calculateOptsWidth(),
                      (a = i.el),
                      i.setOpenAmount('end' === t ? i.optsWidthRightSide : -i.optsWidthLeftSide, !1),
                      (i.state = 'end' === t ? 8 : 16);
                  })));
            })();
          }
          ...
          closeOpened() {
            return (0, d.Z)(function* () {
              return void 0 !== a && (a.close(), (a = void 0), !0);
            })();
          }
          getOptions(t) {
            return void 0 === t
          ...
          updateOptions() {
            ...
            return (0, d.Z)(function* () {
              ...
              for (let s = 0; s < i.length; s++) {
                const o = i.item(s),
                  l = void 0 !== o.componentOnReady ? yield o.componentOnReady() : o;
                'start' == ((0, m.n)(l.side) ? 'end' : 'start')
                  ? ((t.leftOptions = l), (e |= 1))
                  : ((t.rightOptions = l), (e |= 2));
              }
          ...
          canStart(t) {
            return (
              ...
              (a && a !== this.el && this.closeOpened(), !(!this.rightOptions && !this.leftOptions))
            );
          }
          ...
          onMove(t) {
            ...
            i > this.optsWidthRightSide
              ...
              : i < -this.optsWidthLeftSide && ((e = -this.optsWidthLeftSide), (i = e + 0.55 * (i - e))),
          ...
          onEnd(t) {
            ...
            const s = this.openAmount > 0 == !(i < 0),
              o = Math.abs(i) > 0.3,
              l = Math.abs(this.openAmount) < Math.abs(e / 2);
            C(s, o, l) && (e = 0);
            const h = this.state;
            this.setOpenAmount(e, !0),
              0 != (32 & h) && this.rightOptions
                ? this.rightOptions.fireSwipeEvent()
                : 0 != (64 & h) && this.leftOptions && this.leftOptions.fireSwipeEvent();
          }
          calculateOptsWidth() {
            (this.optsWidthRightSide = 0),
              this.rightOptions &&
            ...
            if (((this.openAmount = t), i && (e.transition = ''), t > 0))
              ...
              if (!(t < 0))
                return (
                  ...
                  (this.tmr = setTimeout(() => {
                    (this.state = 2), (this.tmr = void 0), this.gesture && this.gesture.enable(!0);
                  }, 600)),
                  (a = void 0),
                  void (e.transform = '')
                );
