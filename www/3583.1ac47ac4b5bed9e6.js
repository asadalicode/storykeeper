...
(self.webpackChunkngx_new = self.webpackChunkngx_new || []).push([
  ...
  {
    3583: (P, u, c) => {
      c.r(u), c.d(u, { ion_reorder: () => g, ion_reorder_group: () => E });
      var x = c(5861),
        i = c(9533),
        f = c(7639),
        y = c(6499),
      ...
      let g = class {
        ...
        onClick(e) {
          ...
          e.preventDefault(), (!t || !t.disabled) && e.stopImmediatePropagation();
        }
        render() {
          const e = (0, f.b)(this);
          return (0, i.h)(
            ...
            (0, i.h)(
              ...
              null,
              (0, i.h)('ion-icon', {
                name: 'ios' === e ? 'reorder-three-outline' : 'reorder-two-sharp',
                lazy: !1,
                class: 'reorder-icon',
                part: 'icon',
              })
      ...
      let E = class {
        ...
        connectedCallback() {
          ...
          return (0, x.Z)(function* () {
            ...
            t && (yield new Promise((s) => (0, y.c)(t, s)), (e.scrollEl = yield t.getScrollElement())),
              (e.gesture = (yield Promise.resolve().then(c.bind(c, 1363))).createGesture({
                el: e.el,
                gestureName: 'reorder',
                gesturePriority: 110,
                threshold: 0,
        ...
        onStart(e) {
          ...
          for (let a = 0; a < o.length; a++) {
            const d = o[a];
            (l += d.offsetHeight), s.push(l), (d.$ionIndex = a);
          }
          ...
          if (((this.containerTop = n.top), (this.containerBottom = n.bottom), this.scrollEl)) {
            ...
            (this.scrollElInitial = this.scrollEl.scrollTop),
              (this.scrollElTop = a.top + p),
              (this.scrollElBottom = a.bottom - p);
        ...
        onMove(e) {
          ...
          const s = this.autoscroll(e.currentY),
            ...
            l = Math.max(r, Math.min(e.currentY, this.containerBottom - s)),
            n = s + l - e.startY,
            d = this.itemIndexForTop(l - r);
          if (d !== this.lastToIndex) {
            const B = h(t);
            (this.lastToIndex = d), (0, m.b)(), this.reorderMove(B, d);
          }
        ...
        onEnd() {
          ...
          t === s
            ? this.completeSync()
            : this.ionItemReorder.emit({ from: s, to: t, complete: this.completeSync.bind(this) }),
            (0, m.h)();
        }
        completeSync(e) {
          const t = this.selectedItemEl;
          if (t && 2 === this.state) {
            const s = this.el.children,
              ...
              o = this.lastToIndex,
              l = h(t);
            o === l || (void 0 !== e && !0 !== e) || this.el.insertBefore(t, l < o ? s[o + 1] : s[o]),
              Array.isArray(e) && (e = v(e, l, o));
            for (let n = 0; n < r; n++) s[n].style.transform = '';
            (t.style.transition = ''), t.classList.remove(I), (this.selectedItemEl = void 0), (this.state = 0);
          }
          return e;
        }
        itemIndexForTop(e) {
        ...
        reorderMove(e, t) {
          ...
          for (let o = 0; o < r.length; o++) {
            let n = '';
            o > e && o <= t ? (n = `translateY(${-s}px)`) : o < e && o >= t && (n = `translateY(${s}px)`),
        ...
        autoscroll(e) {
          ...
          let t = 0;
          return (
            e < this.scrollElTop ? (t = -b) : e > this.scrollElBottom && (t = b),
        ...
        render() {
          const e = (0, f.b)(this);
          return (0, i.h)(i.H, {
            class: { [e]: !0, 'reorder-enabled': !this.disabled, 'reorder-list-active': 0 !== this.state },
          });
        }
        get el() {
          return (0, i.i)(this);
