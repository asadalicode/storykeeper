      ...
      let d = class {
          constructor(t) {
            (0, e.r)(this, t),
              ...
              (this.value = ''),
              (this.onInput = (i) => {
                this.nativeInput && (this.value = this.nativeInput.value), this.emitStyle(), this.ionInput.emit(i);
              }),
              (this.onFocus = (i) => {
                (this.hasFocus = !0), this.focusChange(), this.fireFocusEvents && this.ionFocus.emit(i);
              }),
              (this.onBlur = (i) => {
                (this.hasFocus = !1), this.focusChange(), this.fireFocusEvents && this.ionBlur.emit(i);
              }),
              (this.onKeyDown = () => {
          ...
          debounceChanged() {
            this.ionChange = (0, n.j)(this.ionChange, this.debounce);
          }
          disabledChanged() {
            this.emitStyle();
          }
          ...
          componentWillLoad() {
            this.inheritedAttributes = (0, n.i)(this.el, ['title']);
          }
          componentDidLoad() {
          ...
          render() {
            ...
            return (
              ...
              (0, e.h)(
                e.H,
                { 'aria-disabled': this.disabled ? 'true' : null, class: (0, c.c)(this.color, { [t]: !0 }) },
                (0, e.h)(
                  'div',
                  { class: 'textarea-wrapper', ref: (r) => (this.textareaWrapper = r) },
                  (0, e.h)(
                    'textarea',
                    Object.assign(
                      {
