  ...
  [2073],
  {
    2073: (x, g, i) => {
      ...
      let l = class {
        constructor(n) {
          ...
          (0, t.r)(this, n),
            ...
            (this.onClick = (function () {
              var d = (0, u.Z)(function* (a) {
                const e = r.el.closest('ion-nav');
                return (
                  a.preventDefault(),
                  e && (yield e.canGoBack())
                    ? e.pop({ animationBuilder: r.routerAnimation, skipIfBusy: !0 })
                    : (0, s.o)(r.defaultHref, a, 'back', r.routerAnimation)
                );
              });
              return function (a) {
        ...
        componentWillLoad() {
          (this.inheritedAttributes = (0, h.i)(this.el, ['aria-label'])),
            void 0 === this.defaultHref && (this.defaultHref = o.c.get('backButtonDefaultHref'));
        }
        get backButtonIcon() {
          const n = this.icon;
          return null != n
            ? n
            : 'ios' === (0, o.b)(this)
            ? o.c.get('backButtonIcon', 'chevron-back')
            : o.c.get('backButtonIcon', 'arrow-back-sharp');
        }
        get backButtonText() {
          const n = 'ios' === (0, o.b)(this) ? 'Back' : null;
          return null != this.text ? this.text : o.c.get('backButtonText', n);
        }
        get hasIconOnly() {
        ...
        render() {
          ...
          return (0, t.h)(
            ...
            (0, t.h)(
              'button',
              { type: a, disabled: d, class: 'button-native', part: 'native', 'aria-label': w },
              (0, t.h)(
                'span',
                { class: 'button-inner' },
                p && (0, t.h)('ion-icon', { part: 'icon', icon: p, 'aria-hidden': 'true', lazy: !1 }),
                c && (0, t.h)('span', { part: 'text', 'aria-hidden': 'true', class: 'button-text' }, c)
              ),
              'md' === b && (0, t.h)('ion-ripple-effect', { type: this.rippleType })
            )
          );
        }
        get el() {
