  ...
  [9922],
  {
    9922: (C, s, o) => {
      ...
      let d = class {
          constructor(i) {
            (0, e.r)(this, i),
              (this.ionChange = (0, e.e)(this, 'ionChange', 7)),
              (this.ionFocus = (0, e.e)(this, 'ionFocus', 7)),
              (this.ionBlur = (0, e.e)(this, 'ionBlur', 7)),
              (this.ionStyle = (0, e.e)(this, 'ionStyle', 7)),
              (this.inputId = 'ion-cb-' + u++),
              ...
              (this.value = 'on'),
              (this.onClick = (t) => {
                t.preventDefault(), this.setFocus(), (this.checked = !this.checked), (this.indeterminate = !1);
              }),
              (this.onFocus = () => {
                this.ionFocus.emit();
              }),
          ...
          checkedChanged(i) {
            this.ionChange.emit({ checked: i, value: this.value }), this.emitStyle();
          }
          disabledChanged() {
            this.emitStyle();
          }
          ...
          render() {
            const { color: i, checked: t, disabled: r, el: n, indeterminate: a, inputId: c, name: x, value: f } = this,
              b = (0, m.b)(this),
              { label: v, labelId: w, labelText: y } = (0, h.e)(n, c);
            (0, h.h)(!0, n, x, t ? f : '', r);
            let k = (0, e.h)(
              'path',
              a ? { d: 'M6 12L18 12', part: 'mark' } : { d: 'M5.9,12.5l3.8,3.8l8.8-8.8', part: 'mark' }
            );
            return (
              'md' === b &&
                (k = (0, e.h)(
                  'path',
                  a ? { d: 'M2 12H22', part: 'mark' } : { d: 'M1.73,12.91 8.1,19.28 22.79,4.59', part: 'mark' }
                )),
              (0, e.h)(
                e.H,
                {
                  onClick: this.onClick,
                  'aria-labelledby': v ? w : null,
                  'aria-checked': `${t}`,
                  'aria-hidden': r ? 'true' : null,
                  role: 'checkbox',
                  class: (0, l.c)(i, {
                    [b]: !0,
                    'in-item': (0, l.h)('ion-item', n),
                    'checkbox-checked': t,
                    'checkbox-disabled': r,
                ...
                (0, e.h)('svg', { class: 'checkbox-icon', viewBox: '0 0 24 24', part: 'container' }, k),
                (0, e.h)('label', { htmlFor: c }, y),
                (0, e.h)('input', {
                  type: 'checkbox',
                  'aria-checked': `${t}`,
                  disabled: r,
