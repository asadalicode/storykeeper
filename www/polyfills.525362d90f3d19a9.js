        ...
        class T {
          constructor(p, t, o) {
            ...
            (g || (t && t._hasTaskZS)) &&
              ...
              o.onScheduleTask ||
                ((this._scheduleTaskZS = y), (this._scheduleTaskDlgt = t), (this._scheduleTaskCurrZone = this.zone)),
              o.onInvokeTask ||
                ((this._invokeTaskZS = y), (this._invokeTaskDlgt = t), (this._invokeTaskCurrZone = this.zone)),
              o.onCancelTask ||
                ((this._cancelTaskZS = y), (this._cancelTaskDlgt = t), (this._cancelTaskCurrZone = this.zone)));
          }
          fork(p, t) {
          ...
          invokeTask(p, t, o, g) {
            return this._invokeTaskZS
              ? this._invokeTaskZS.onInvokeTask(this._invokeTaskDlgt, this._invokeTaskCurrZone, p, t, o, g)
          ...
          (r.set = function (T) {
            ...
            !m && e === $ && (m = $),
              m &&
                ...
                f && f.apply(m, ht),
                'function' == typeof T ? ((m[y] = T), m.addEventListener(_, qe, !1)) : (m[y] = null));
          }),
          (r.get = function () {
            let T = this;
      ...
      function _t(e, n, i) {
        ...
        r = ce(
          ...
          (u) =>
            function (f, _) {
              const y = i(f, _);
              return y.cbIdx >= 0 && 'function' == typeof _[y.cbIdx] ? Me(y.name, _[y.cbIdx], y, c) : u.apply(f, _);
            }
        );
      }
      function ae(e, n) {
            ...
            l = function (s, a, h, w, C = !1, k = !1) {
              return function () {
                ...
                let De,
                  ...
                  ct = !1;
                if (ye) {
                  if (((ct = !0), j)) for (let _e = 0; _e < ye.length; _e++) if (g(ye[_e], H)) return;
                } else ye = b[it] = [];
            ...
            y &&
              ...
              c.forEach(function (m) {
                ...
                if (D.hasOwnProperty(m)) {
                  ...
                  Z && Z.value
                    ? ((Z.value = e.wrapWithCurrentZone(Z.value, S)), e._redefineProperty(y.prototype, m, Z))
