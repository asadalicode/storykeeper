...
(self.webpackChunkngx_new = self.webpackChunkngx_new || []).push([
  ...
  {
    7544: (j, m, c) => {
      c.r(m), c.d(m, { ion_breadcrumb: () => u, ion_breadcrumbs: () => f });
      var o = c(9533),
        h = c(6223),
        g = c(7639),
        y = c(6499),
      ...
      let u = class {
        ...
        componentWillLoad() {
          this.inheritedAttributes = (0, y.i)(this.el, ['aria-label']);
        }
        isClickable() {
        ...
        render() {
          const {
              ...
              routerDirection: E,
              separator: z,
              showCollapsedIndicator: x,
              target: M,
            } = this,
            v = this.isClickable(),
            k = void 0 === this.href ? 'span' : 'a',
            w = e ? void 0 : this.href,
            C = (0, g.b)(this),
            O = 'span' === k ? {} : { download: i, href: w, target: M },
            D = !n && (t ? !(!x || n) : z);
          return (0, o.h)(
            o.H,
            {
              onClick: (p) => (0, l.o)(w, p, E, b),
              'aria-disabled': e ? 'true' : null,
              class: (0, l.c)(s, {
                [C]: !0,
                'breadcrumb-active': a,
                'breadcrumb-collapsed': t,
                'breadcrumb-disabled': e,
                'in-breadcrumbs-color': (0, l.h)('ion-breadcrumbs[color]', d),
            ...
            (0, o.h)(
              ...
              Object.assign(
                {},
                O,
                { class: 'breadcrumb-native', part: 'native', disabled: e, onFocus: this.onFocus, onBlur: this.onBlur },
                r
              ),
            ...
            x &&
              (0, o.h)(
                'button',
                {
                  ...
                  ref: (p) => (this.collapsedRef = p),
                  class: { 'breadcrumbs-collapsed-indicator': !0 },
                },
                (0, o.h)('ion-icon', { icon: h.e, lazy: !1 })
              ),
            D &&
              (0, o.h)(
                'span',
                { class: 'breadcrumb-separator', part: 'separator' },
                (0, o.h)(
                  'slot',
                  { name: 'separator' },
                  'ios' === C ? (0, o.h)('ion-icon', { icon: h.b, lazy: !1 }) : (0, o.h)('span', null, '/')
                )
              )
          );
        }
      ...
      let f = class {
        constructor(s) {
          (0, o.r)(this, s),
            ...
            (this.resetActiveBreadcrumb = () => {
              const t = this.getBreadcrumbs().find((e) => e.active);
              t && this.activeChanged && (t.active = !1);
            }),
            (this.setMaxItems = () => {
              const { itemsAfterCollapse: a, itemsBeforeCollapse: t, maxItems: e } = this,
                i = this.getBreadcrumbs();
              for (const r of i) (r.showCollapsedIndicator = !1), (r.collapsed = !1);
              void 0 !== e &&
                i.length > e &&
                t + a <= e &&
                i.forEach((r, n) => {
                  n === t && (r.showCollapsedIndicator = !0), n >= t && n < i.length - a && (r.collapsed = !0);
                });
            }),
            (this.setBreadcrumbSeparator = () => {
              const { itemsAfterCollapse: a, itemsBeforeCollapse: t, maxItems: e } = this,
                ...
                d = i.find((r) => r.active);
              for (const r of i) {
                const n = void 0 !== e && 0 === a ? r === i[t] : r === i[i.length - 1];
                (r.last = n),
                  (r.separator = void 0 !== r.separator ? r.separator : !n || void 0),
                  !d && n && ((r.active = !0), (this.activeChanged = !0));
              }
            }),
            (this.getBreadcrumbs = () => Array.from(this.el.querySelectorAll('ion-breadcrumb')));
        }
        onCollapsedClick(s) {
          const t = this.getBreadcrumbs().filter((e) => e.collapsed);
          this.ionCollapsedClick.emit(Object.assign(Object.assign({}, s.detail), { collapsedBreadcrumbs: t }));
        }
        maxItemsChanged() {
        ...
        render() {
          const { color: s, collapsed: a } = this,
            t = (0, g.b)(this);
          return (0, o.h)(
            o.H,
            {
