...
(self.webpackChunkngx_new = self.webpackChunkngx_new || []).push([
  ...
  {
    438: (z, l, n) => {
      n.r(l), n.d(l, { ion_tab_bar: () => s, ion_tab_button: () => d });
      var t = n(9533),
        a = n(7639),
        g = n(7300);
      let s = class {
        constructor(o) {
          (0, t.r)(this, o),
            (this.ionTabBarChanged = (0, t.e)(this, 'ionTabBarChanged', 7)),
        ...
        render() {
          const { color: o, translucent: e, keyboardVisible: i } = this,
            r = (0, a.b)(this);
          return (0, t.h)(
            t.H,
            {
              ...
              class: (0, g.c)(o, { [r]: !0, 'tab-bar-translucent': e, 'tab-bar-hidden': i }),
            },
            (0, t.h)('slot', null)
          );
        }
      ...
      let d = class {
        constructor(o) {
          (0, t.r)(this, o),
            (this.ionTabButtonClick = (0, t.e)(this, 'ionTabButtonClick', 7)),
            (this.disabled = !1),
            (this.selected = !1),
            (this.onKeyUp = (e) => {
        ...
        onTabBarChanged(o) {
          ...
          ((o.composedPath && o.composedPath().includes(i)) || (e && e.contains(this.el))) &&
            (this.selected = this.tab === o.detail.tab);
        }
        componentWillLoad() {
          void 0 === this.layout && (this.layout = a.c.get('tabButtonLayout', 'icon-top'));
        }
        selectTab(o) {
          void 0 !== this.tab &&
          ...
          return (0, t.h)(
            t.H,
            {
              ...
              class: {
                ...
                'tab-has-label': i,
                'tab-has-icon': e,
                'tab-has-label-only': i && !e,
                'tab-has-icon-only': e && !i,
                [`tab-layout-${k}`]: !0,
                'ion-activatable': !0,
                'ion-selectable': !0,
                'ion-focusable': !0,
            ...
            (0, t.h)(
              ...
              Object.assign(
                {},
                { download: this.download, href: m, rel: y, target: v },
                { tabIndex: -1, class: 'button-native', part: 'native' }
              ),
              (0, t.h)('span', { class: 'button-inner' }, (0, t.h)('slot', null)),
              'md' === h && (0, t.h)('ion-ripple-effect', { type: 'unbounded' })
            )
          );
        }
        get el() {
