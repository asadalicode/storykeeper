      ...
      let p = class {
        constructor(e) {
          (0, o.r)(this, e),
            ...
            (this.cancelButtonIcon = l.c.get('backButtonIcon', 'arrow-back-sharp')),
        ...
        debounceChanged() {
          this.ionChange = (0, d.j)(this.ionChange, this.debounce);
        }
        valueChanged() {
          const e = this.nativeInput,
            a = this.getValue();
          e && e.value !== a && (e.value = a), this.ionChange.emit({ value: a });
        }
        ...
        positionElements() {
          ...
          (this.shouldAlignLeft = i),
            'ios' === r && (a !== i && this.positionPlaceholder(), this.animated && this.positionCancelButton());
        }
        positionPlaceholder() {
          const e = this.nativeInput;
          if (!e) return;
          const a = 'rtl' === document.dir,
            r = (this.el.shadowRoot || this.el).querySelector('.searchbar-search-icon');
          if (this.shouldAlignLeft) e.removeAttribute('style'), r.removeAttribute('style');
          else {
            const i = document,
              t = i.createElement('span');
            (t.innerText = this.placeholder || ''),
              i.body.appendChild(t),
              (0, d.r)(() => {
                const c = t.offsetWidth;
                t.remove();
                const h = 'calc(50% - ' + c / 2 + 'px)',
                  n = 'calc(50% - ' + (c / 2 + 30) + 'px)';
                a
                  ? ((e.style.paddingRight = h), (r.style.marginRight = n))
                  : ((e.style.paddingLeft = h), (r.style.marginLeft = n));
              });
          }
        }
        positionCancelButton() {
          ...
          if (a && r !== this.isCancelVisible) {
            const i = a.style;
            if (((this.isCancelVisible = r), r)) e ? (i.marginLeft = '0') : (i.marginRight = '0');
            else {
              const t = a.offsetWidth;
              t > 0 && (e ? (i.marginLeft = -t + 'px') : (i.marginRight = -t + 'px'));
            }
          }
        }
        getValue() {
        ...
        render() {
          const { cancelButtonText: e } = this,
            a = this.animated && l.c.getBoolean('animated', !0),
            r = (0, l.b)(this),
            ...
            h =
              ...
              (0, o.h)(
                ...
                (0, o.h)(
                  ...
                  { 'aria-hidden': 'true' },
                  'md' === r
                    ? (0, o.h)('ion-icon', { 'aria-hidden': 'true', mode: r, icon: this.cancelButtonIcon, lazy: !1 })
                    : e
                )
              );
          return (0, o.h)(
            ...
            (0, o.h)(
              ...
              (0, o.h)(
                'button',
                {
                  ...
                  onMouseDown: (n) => this.onClearInput(n, !0),
                  onTouchStart: (n) => this.onClearInput(n, !0),
                },
                (0, o.h)('ion-icon', {
                  'aria-hidden': 'true',
                  mode: r,
