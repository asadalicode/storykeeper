  ...
  [9536],
  {
    9536: (u, l, o) => {
      ...
      let b = class {
        constructor(e) {
          (0, r.r)(this, e),
            (this.ionSplitPaneVisible = (0, r.e)(this, 'ionSplitPaneVisible', 7)),
            (this.visible = !1),
            (this.disabled = !1),
            (this.when = p.lg);
        }
        ...
        connectedCallback() {
          ...
          return (0, w.Z)(function* () {
            'undefined' != typeof customElements && (yield customElements.whenDefined('ion-split-pane')),
              e.styleChildren(),
              e.updateState();
          })();
        }
        ...
        updateState() {
          ...
          if (0 !== t.length) {
            if (window.matchMedia) {
              ...
              i.addListener(s), (this.rmL = () => i.removeListener(s)), (this.visible = i.matches);
            }
          } else this.visible = !1;
        }
        isPane(e) {
          return !!this.visible && e.parentElement === this.el && e.classList.contains(d);
        }
        styleChildren() {
          ...
          for (let n = 0; n < s; n++) {
            const h = t[n],
              m = void 0 !== e && h.id === e;
            if (m) {
              if (i) return void console.warn('split pane cannot have more than one main node');
              i = !0;
            }
            x(h, m);
          }
